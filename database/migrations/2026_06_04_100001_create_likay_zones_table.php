...
return new class extends Migration
{
    ...
    {
        Schema::create('likay_zones', function (Blueprint $table) {
            $table->id();
        ...
        // Read existing prices from likay_zone_prices
        $existingPrices = DB::table('likay_zone_prices')->pluck('price', 'zone')->all();
    ...
    {
        // Recreate likay_zone_prices from zones
        ...
        $now = now();
        $zones = DB::table('likay_zones')->get();
        foreach ($zones as $zone) {
        ...
        Schema::dropIfExists('likay_zones');
    }
};
