...
use App\Http\Controllers\LikayLiveAtTheTheaterController;
...
Route::post('/LikayLiveAtTheTheater/login', [LikayLiveAtTheTheaterController::class, 'doLogin'])->middleware('throttle:5,1')->name('likay.login.post');
...
Route::get('/LikayLiveAtTheTheater/zones', [LikayLiveAtTheTheaterController::class, 'listZones'])->name('likay.zones.list');
Route::post('/LikayLiveAtTheTheater/zones', [LikayLiveAtTheTheaterController::class, 'createZone'])->name('likay.zones.create');
Route::put('/LikayLiveAtTheTheater/zones/{id}', [LikayLiveAtTheTheaterController::class, 'updateZone'])->name('likay.zones.update');
Route::delete('/LikayLiveAtTheTheater/zones/{id}', [LikayLiveAtTheTheaterController::class, 'deleteZone'])->name('likay.zones.delete');
...
Route::prefix('admin')->name('admin.')->group(function () use (
    ...
    Route::post('/easy-documents/create', function (Request $request) use ($ensureAdmin, $currentAdmin) {
        ...
        try {
            $result = app(\App\Services\EasyDocumentService::class)->create($data, $currentAdmin()?->id);
