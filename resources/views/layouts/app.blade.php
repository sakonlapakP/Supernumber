        ...
        <div class="privacy-modal__body">
          ...
          <div class="privacy-option-card">
            <div class="privacy-option-card__head">
              ...
              <p>ความยินยอมในการเก็บรวบรวม ใช้ หรือเปิดเผยข้อมูลส่วนบุคคล เพื่อการลงชื่อเข้าใช้ และรับบริการต่างๆ รวมถึงการจัดทำเอกสารหรือสัญญา ตามวัตถุประสงค์ของลูกค้า <a href="{{ route('privacy') }}?tab=personal" target="_blank">ดูเพิ่มเติม</a></p>
            </div>
          ...
          <div class="privacy-option-card">
            <div class="privacy-option-card__head">
              ...
              <p>เพื่อให้ท่านได้รับความพึงพอใจต่อบริการของเราอย่างต่อเนื่อง ทางบริษัทจะปรับปรุงและพัฒนาสินค้าและบริการให้ดียิ่งขึ้น <a href="{{ route('privacy') }}?tab=development" target="_blank">ดูเพิ่มเติม</a></p>
            </div>
            <div class="privacy-option-card__controls">
              <label class="privacy-radio">
          ...
          <div class="privacy-option-card">
            <div class="privacy-option-card__head">
              ...
              <p>เพื่อให้ท่านไม่พลาดข้อเสนอพิเศษของผลิตภัณฑ์หรือบริการ ทางเราขอเรียนเชิญให้ท่านเข้าร่วมกิจกรรมต่างๆ <a href="{{ route('privacy') }}?tab=marketing" target="_blank">ดูเพิ่มเติม</a></p>
            </div>
            <div class="privacy-option-card__controls">
              <label class="privacy-radio">
