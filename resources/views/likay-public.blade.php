    ...
    <div class="chart">
      ...
      <div style="display:flex;align-items:stretch;justify-content:center;gap:8px;margin-bottom:8px;padding:8px 0;">
        ...
        <div style="display:flex;flex-direction:column;gap:2px;align-items:flex-end;">
          <div style="font-size:10px;font-weight:700;color:#555;text-align:center;margin-bottom:2px;">แถว V/W</div>
        ...
        <div style="display:flex;flex-direction:column;align-items:center;justify-content:flex-end;">
          <div style="font-size:10px;font-weight:700;color:#555;margin-bottom:2px;">Control</div>
          <div class="vvip-box" style="height:54px;display:flex;align-items:center;justify-content:center;margin-top:auto;">Control</div>
        </div>
      ...
      @php
        ...
        $rows = [
          ...
          ['L','pink',   $r(1,8), $r(9,16),  $r(17,24), $r(25,32), ['k'=>'BOXB_8', 'n'=>8, 'z'=>'box'], ['k'=>'BOXE_21','n'=>21,'z'=>'box']],
